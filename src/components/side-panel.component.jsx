    ...
    <div className=" side-panel side-panel-hide bg-main-700 pt-16 flex flex-col items-center justify-center">
      <a href="#home">
        <li onClick={()=>{document
            ...
            .classList.toggle("side-panel-hide");}} className="nav-link  text-content-200 text-xl py-4 flex flex-col items-center justify-center hover:text-accent-100 hover:cursor-pointer font-['Fira_Mono']">
      ...
      <li onClick={()=>{document
            .querySelector(".side-panel")
            .classList.toggle("side-panel-hide");}} className="nav-link font-['Fira_Mono'] my-12">
