...
const FeaturedProjects = ()=>{
    return <section className="featured-projects-directory max-w-[1000px] m-auto mt-20" id="projects">

        <LineHeading index={'03'} ><span className="min-w-max text-2xl lg:text-3xl ">Some Projects</span></LineHeading>
