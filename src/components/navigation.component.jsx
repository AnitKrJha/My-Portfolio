...
const Navigation = () => {
  return (
    <div className="flex items-center justify-between px-4 py-3 navigation-container text-primary bg-main text-3xl" onScroll={(e)=>{console.log(e);}}>
      ...
      <ul className="nav-links  gap-4 text-base items-center hidden sm:flex">
        ...
        <li className="nav-link font-['Fira_Mono']"><Button>Resume</Button></li>
      </ul>
