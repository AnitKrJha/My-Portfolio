...
const About = () => {
  return (
    <section className="about-me-container min-h-[75vh] py-32 pointer-events-none"id="about">
      <div className="inner-container lg:w-[85%] md:w-[100%] w-[100%] px-0 md:px-0 m-auto  flex flex-col md:flex-row md:gap-16 gap-10  items-center md:items-stretch md:justify-around">
        <div className="about-left max-w-lg  ">
          <LineHeading index={"01"}>
            <span className="min-w-max text-2xl lg:text-3xl pointer-events-auto">About Me</span>
          </LineHeading>
          <p className="about-content  lg:text-[17px] text-content-300 mb-2 mt-10 pointer-events-auto">
          ...
          <p className="about-content text-base lg:text-[17px] text-content-300 mb-2 pointer-events-auto">
          ...
          <p className="about-content lg:text-[17px] text-content-300 mb-2 pointer-events-auto">
          ...
          <p className="text-content-300 pointer-events-auto">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ratione, tempora!</p>

            <div className="tech-stack grid grid-rows-3 grid-cols-2 font-['Fira_Mono'] gap-x-4 text-content-200 mt-4 pointer-events-auto">
